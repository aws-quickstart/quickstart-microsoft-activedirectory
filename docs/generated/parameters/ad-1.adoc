...
(`PKI`)|`No`|Do you want to deploy a Single Tier PKI Enterpise CA|Enterprise Root CA Subnet ID
(`EntCaServerSubnet`)|`**__Requires input__**`|ID of the private subnet 1 or 2 in Availability Zone 1 or 2  (e.g., subnet-a0246dcd)|Enterprise Root CA IP Address
