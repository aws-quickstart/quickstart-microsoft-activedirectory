...
(`MgmtAmi`)|`/aws/service/ami-windows-latest/Windows_Server-2019-English-Full-Base`|Management Server SSM Parameter Value to grab the latest AMI ID|Data Drive Size
...
(`CaAmi`)|`/aws/service/ami-windows-latest/Windows_Server-2019-English-Full-Base`|Enterprise Root CA SSM Parameter Value to grab the latest AMI ID|CA Data Drive Size
